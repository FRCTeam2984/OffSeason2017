...
public class RobotMap {
	public static final int FRONT_LEFT_MOTOR_ID = 23;
	public static final int FRONT_RIGHT_MOTOR_ID = 22;
	public static final int REAR_LEFT_MOTOR_ID = 12;
	public static final int REAR_RIGHT_MOTOR_ID = 10;
	...
	public static final double VALUE_LOW = 83;
	public static final double VALUE_HIGH = 146;
	public static final double HUE_LOW = 76;
	public static final double HUE_HIGH = 106;
	public static final double SATURATION_LOW = 71;
	public static final double SATURATION_HIGH = 116;
	...
	public static final double INCHES_PER_TICK_DRIVEN = 1/80D;
	
	public static double LINEAR_DRIVE_P = 0.02;
	public static double ANGULAR_DRIVE_P = -0.004;
	...
	public static final double DISTANCE_BETWEEN_WHEELS = 19.75;
